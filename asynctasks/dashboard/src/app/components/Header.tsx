...
export default function Header({ 
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === "k" && (e.metaKey || e.ctrlKey)) {
        e.preventDefault(); // Always prevent default browser behavior (e.g., search bar focus)
        
        // Disable shortcut if any modal (internal or external) is already open
        const isAnyModalOpen = isProfileOpen || isNotificationsOpen || isSettingsOpen || isModalOpen;
  ...
  }, [isProfileOpen, isNotificationsOpen, isSettingsOpen, isModalOpen]);
